...
int main() {
    ...
    for (int epoch : boost::irange(1,NUMBER_OF_EPOCHS+1)) {
        ...
        // std::cout << "The matrix dense_layer_1.output " << dense_layer_1.output << std::endl;
       ...
       // get predictions and accuracy
        ...
        Eigen::VectorXd predictions(activation_softmax.output.rows());
        ...
        // std::cout << "Layer 1 weights" << dense_layer_1.weights.mean() << std::endl;
