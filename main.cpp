...
int main() {
    ...
    for (int epoch : boost::irange(0,NUMBER_OF_EPOCHS)) {
        ...
        // std::cout << "The matrix X_train is of size " << X_train.rows() << "x" << X_train.cols() << std::endl;
        // std::cout << "\nThe matrix dense_layer_1.output " << dense_layer_1.output << std::endl;
       ...
       // get predictions and accuracy
        ...
        // std::cout << "\nLayer 2 inputs \n" << dense_layer_2.inputs.row(1) << std::endl;
        // std::cout << "\ndinputs for dense 2 \n" << activation_softmax.dinputs << std::endl;
        ...
        // std::cout << "\nLayer 2 dinputs \n" << dense_layer_2.dinputs.row(1) << std::endl;
        // std::cout << "\nLayer 2 dweights \n" << dense_layer_2.dweights.row(1) << std::endl;
        // std::cout << "\nLayer 2 dbiases \n" << dense_layer_2.dbiases.row(1) << std::endl;
        activation_relu.backward(dense_layer_2.dinputs);
        // std::cout << "\nactivation_relu.dinputs \n" << activation_relu.dinputs.row(1) << std::endl;
        dense_layer_1.backward(activation_relu.dinputs);
        // std::cout << "\nLayer 1 dinputs \n" << dense_layer_1.dinputs.row(1) << std::endl;
        // std::cout << "\nLayer 1 dweights \n" << dense_layer_1.dweights.row(1) << std::endl;
        // std::cout << "\nLayer 1 dbiases \n" << dense_layer_1.dbiases.row(1) << std::endl;
